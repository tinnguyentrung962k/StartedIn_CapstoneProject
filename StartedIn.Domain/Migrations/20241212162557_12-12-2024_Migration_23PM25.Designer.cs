...
namespace StartedIn.Domain.Migrations
{
    ...
    [Migration("20241212162557_12-12-2024_Migration_23PM25")]
    partial class _12122024_Migration_23PM25
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StartedIn.Domain.Entities.MeetingNote", b =>
                {
                    ...
                    b.Property<string>("SignNowFileId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("StartedIn.Domain.Entities.TerminationConfirmation", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
                    ...
                    b.ToTable("TerminationConfirmation", (string)null);
                });
            ...
            modelBuilder.Entity("StartedIn.Domain.Entities.TerminationConfirmation", b =>
                {
                    b.HasOne("StartedIn.Domain.Entities.TerminationRequest", "TerminationRequest")
                        .WithMany("TerminationConfirmations")
            ...
            modelBuilder.Entity("StartedIn.Domain.Entities.TerminationRequest", b =>
                {
                    b.Navigation("TerminationConfirmations");
                });
