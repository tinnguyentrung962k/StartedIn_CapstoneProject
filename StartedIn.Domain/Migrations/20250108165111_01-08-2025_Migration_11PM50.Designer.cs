...
namespace StartedIn.Domain.Migrations
{
    ...
    [Migration("20250108165111_01-08-2025_Migration_11PM50")]
    partial class _01082025_Migration_11PM50
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StartedIn.Domain.Entities.ApplicationFile", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("StartedIn.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AppointmentEndTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("StartedIn.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<string>("ProjectDetailPost")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("StartedIn.Domain.Entities.UserAppointment", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("StartedIn.Domain.Entities.ApplicationFile", b =>
                {
                    b.HasOne("StartedIn.Domain.Entities.Application", null)
